...
def load_config_from_toml(config_file: Path) -> ValidatorConfig:
    ...
    validator_parameters: dict[str, Any] = config_content.get('docs_validator', {})
    ...
    config = ValidatorConfig(
        ...
        external_anchor_user_agent=validator_parameters.get('external_anchor_user_agent', 'docs_validator/0.0.1'),
    )
